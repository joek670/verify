...
[`docs/dsh-openrouter-windows.md`](docs/dsh-openrouter-windows.md) is here for the same
reason. It records how to hand DSH an OpenRouter API key on Windows through the
environment that launched it. Nothing in this project reads that key or talks to
OpenRouter.
